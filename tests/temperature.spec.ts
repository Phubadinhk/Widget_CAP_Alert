...
test('Performance temperature Page', async () => {
  ...
  console.log(`Performance Result Temperature Page`); 
  ...
  console.log('----------------------------');
  console.log(`Success Runs: ${finishTimes.length}/${TEMPERATURE_PERFORMANCE_DATA.TOTAL_RUNS}`);
